...
HD_PWD='F:/MIPS_CPU/vga_controller/vga_controller/vga_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_ToplevelShell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_ToplevelShell.tcl -notrace
