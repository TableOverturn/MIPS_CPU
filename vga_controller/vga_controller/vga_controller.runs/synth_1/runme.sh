...
HD_PWD='F:/MIPS_CPU/vga_controller/vga_controller/vga_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_ToplevelShell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_ToplevelShell.tcl
